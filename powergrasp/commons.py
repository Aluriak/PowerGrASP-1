...
ASP_SRC_STABLE_CONSTRAINT = __asp_file('exclude_stable')
# Scoring
...
ASP_ARG_MAX_SET_SIZE = 'max_set_size'
ASP_ARGS_NAMES = (ASP_ARG_CC, ASP_ARG_STEP, ASP_ARG_UPPERBOUND,
                  ASP_ARG_LOWERBOUND, ASP_ARG_MAX_SET_SIZE)
